...
#*****************************************************************************
#
def XsConfigureWriteToDisk(hCamera,nEnable,lpszDiskDrives,lpszDirectory,nRamBufferSize):
    error = XStreamDrv.XsConfigureWriteToDisk(hCamera,nEnable,lpszDiskDrives,lpszDirectory,nRamBufferSize)
    _xs_error_check(error)
